...
class InputReaderTest {
    ...
    @Test
    void getIntegerGrid() throws FileNotFoundException {
        List<List<Pair<Integer, Boolean>>> result = inputReader.getIntegerGrid("08-test");
        
        result.forEach(trees -> {
            trees.forEach(tree -> assertEquals(false, tree.getValue1()));
        });
    ...
    void getSecond() throws FileNotFoundException {
        List<List<Pair<Integer, Integer>>> result = inputReader.getSecond("08-test");
